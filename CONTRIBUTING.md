...
FlexAlloc uses the Apache 2.0 LICENSE to strike a balance between open contribution
...
To make a good faith effort to ensure these criteria are met, FlexAlloc requires
...
```
Signed-off-by: John Doe <jon.doe@example.com>
```
